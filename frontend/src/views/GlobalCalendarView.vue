...
<template>
    <div class="h-full flex flex-col font-sans p-6 bg-slate-50 overflow-y-auto relative pb-20">
        ...
        <div class="flex justify-between items-center mb-6 shrink-0">
            ...
            <div
                class="flex gap-4 text-xs items-center bg-white px-4 py-2 rounded-lg border border-slate-200 shadow-sm">
            ...
            <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl p-6 animate-in zoom-in-95">
                ...
                <div v-if="tabActiva === 'solicitar'" class="space-y-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label
                                class="block text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-2">Desde</label>
                        ...
                        <div>
                            <label
                                class="block text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-2">Hasta</label>
                    ...
                    <div>
                        <label class="block text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-2">Tipo de
                            Ausencia</label>
                    ...
                    <div>
                        <label
                            class="block text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-2">Comentario
                            (Opcional)</label>
                ...
                <div v-else class="space-y-6">
                    <p class="text-sm text-slate-500 bg-rose-50 p-3 rounded-lg border border-rose-100 text-rose-800">
                        Selecciona el rango de fechas en las que deseas <b>cancelar</b> tus ausencias. Solo se borrarán
                        los días
                        en los que tengas algo registrado.
                    </p>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" v-model="form.fechaInicio"
                                class="w-full bg-slate-50 border border-slate-200 text-slate-800 rounded-lg px-3 py-2 font-bold focus:ring-2 focus:ring-rose-500 outline-none">
                        </div>
                        <div>
                            <label
                                class="block text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-2">Hasta</label>
                    ...
                    <button @click="confirmarEliminacion"
                        class="w-full btn-primary py-3 justify-center text-base bg-rose-500 text-white font-bold rounded-lg hover:bg-rose-600 shadow-md transition flex items-center">
