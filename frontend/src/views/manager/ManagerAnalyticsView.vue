    ...
    <div v-if="diasCriticos.length > 0" 
        ...
        <div class="flex-1">
            ...
            <p class="text-amber-800 text-sm mb-3 leading-relaxed">
                Se ha detectado una alta concurrencia de vacaciones (<strong>3 o más personas</strong>) en las siguientes fechas. 
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="card p-5 border-l-4 border-l-blue-500 flex flex-col justify-between">
            <div class="flex justify-between items-start">
                ...
                <div class="p-2 bg-blue-50 text-blue-600 rounded-lg"><Clock class="w-5 h-5" /></div>
            </div>
        ...
        <div class="card p-5 border-l-4 border-l-emerald-500 flex flex-col justify-between">
            <div class="flex justify-between items-start">
                ...
                <div class="p-2 bg-emerald-50 text-emerald-600 rounded-lg"><Users class="w-5 h-5" /></div>
            </div>
        ...
        <div class="card p-5 border-l-4 border-l-rose-500 flex flex-col justify-between">
            <div class="flex justify-between items-start">
                ...
                <div class="p-2 bg-rose-50 text-rose-600 rounded-lg"><AlertCircle class="w-5 h-5" /></div>
            </div>
                ...
                <div v-for="emp in cargaEmpleados" :key="emp.nombre" class="group">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <div class="text-right">
                             <div class="text-sm font-bold" :class="emp.horas > emp.capacidad ? 'text-rose-600' : 'text-dark'">
                    ...
                    <div class="flex justify-between items-center mt-1">
                        ...
                        <div v-else-if="emp.horas < emp.capacidad * 0.5" class="text-[10px] text-amber-500 font-bold">Baja ocupación</div>
        ...
        <div class="flex flex-col gap-6">
            <div class="card flex flex-col flex-1">
                ...
                <div class="flex-1 overflow-y-auto space-y-4">
                    <div v-for="item in proyectosStats" :key="item.nombre" class="p-3 rounded-xl border border-gray-100 bg-gray-50/50">
                        <div class="flex justify-between items-center mb-2">
                            <div class="flex items-center gap-2">
