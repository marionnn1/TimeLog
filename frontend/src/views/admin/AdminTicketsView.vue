...
<template>
    <div class="h-full flex flex-col font-sans bg-gray-50 p-6 gap-6 overflow-y-auto relative">
        ...
        <div>
            ...
            <p class="subtitle text-gray-500 mt-1 text-sm">Supervisión global de peticiones de modificación de horas.
            </p>
        </div>
            ...
            <div
                ...
                <div class="p-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                    ...
                    <button @click="guardarCorreccion"
                        class="bg-[#26AA9B] hover:bg-[#209083] text-white px-4 py-2 rounded-lg font-bold text-sm transition flex items-center gap-2">
